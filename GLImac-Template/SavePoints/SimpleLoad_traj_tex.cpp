...
int main(int argc, char** argv) {
    ...
    const std::vector<Vertex> vertices2 = listOfVertex(positions2,uvs2,normals2);  
    ...
    const std::vector<Vertex> vertices3 = listOfVertex(positions3,uvs3,normals3);  
    ...
    glBufferData(GL_ARRAY_BUFFER, nvertices2 * sizeof(Vertex), &vertices2[0], GL_STATIC_DRAW);
    glBindBuffer(GL_ARRAY_BUFFER, 0);
    
    glBindBuffer(GL_ARRAY_BUFFER, vbos[2]);
    glBufferData(GL_ARRAY_BUFFER, nvertices3 * sizeof(Vertex), &vertices3[0], GL_STATIC_DRAW);
    glBindBuffer(GL_ARRAY_BUFFER, 0);
