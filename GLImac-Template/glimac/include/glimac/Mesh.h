...
public:
	...
	void updateUniforms(glm::mat4 MatView, Program program)
	{
    	GLuint locationMVMatrix = glGetUniformLocation(program.getGLId(),"uMVMatrix");
        glUniformMatrix4fv(locationMVMatrix,1,GL_FALSE, glm::value_ptr(MatView*ModelMatrix));
	}
	...
	void render(glm::mat4 MatView, Program program)
	{
		//Update uniforms
		this->updateModelMatrix();
		this->updateUniforms(MatView,program);
