...
int main(int argc, char** argv) {
	...
	bool res = loadOBJ("../assets/models/museum/rails.obj", vertices, uvs, normals);
	...
	bool res2 = loadOBJ("../assets/models/rond.obj", vertices, uvs, normals);
	...
	GLuint vbos[6];  // pour les vertices, uvs, and normals
	glGenBuffers(6, vbos);
    ...
    while(!done) {
        ...
        glm::mat4 MVMatrix2 = MatView*glm::translate(MVMatrix2,glm::vec3(verticesTraj[x][0],verticesTraj[x][1],verticesTraj[x][2]));
        x=x+1;
        ...
        //std::cout << "FreeFly" <<Freefly.getPosition().x << std::endl;
        	//std::cout << "Vertices : " << verticesTraj[0] << std::endl;
