...
int main(int argc, char** argv) {
    ...
    FilePath rollerCoasterOBJ = applicationPath.dirPath() + "assets/models/museum/scene_full.obj";
    FilePath wagonOBJ         = applicationPath.dirPath() + "assets/models/museum/wagon.obj";
    FilePath treeOBJ          = applicationPath.dirPath() + "assets/models/museum/rabbitPlayer.obj";
